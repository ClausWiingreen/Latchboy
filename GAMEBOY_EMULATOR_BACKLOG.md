...
- [x] **Priority 2: Clarify “evidence of completion” artifacts**
...
- [x] **Priority 3: Re-scope Milestone 5 naming and order**
...
- [x] **Milestone 4 closure contract**
  ...
  - [x] Enforce one smoke-threshold policy across backlog + `tests/README.md` + CI output messaging.
...
- Emulator CPU-cycle advancement now keeps timer/DIV on the CPU clock while scaling video/audio device ticks by the active CGB speed divisor, preserving existing DMG behavior at normal speed.
